...
#define KEEPER_ANGLE_SX 260
#define KEEPER_ANGLE_DX 80

//POSITION
#define CENTERGOALPOST_VEL1 250
#define CENTERGOALPOST_VEL2 250
#define CENTERGOALPOST_VEL3 220
#define CENTERGOALPOST_CAM_MIN -35
#define CENTERGOALPOST_CAM_MAX 35
